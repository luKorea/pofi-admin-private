 ...
 * @LastEditTime: 2022-07-19 11:26:08
...
import { IUserCenterOrganizationType } from './types'
...
const apiList: any = {
  userCenterOrganizations: '/cms/painter/author/',
...
const userCenterOrganizationModule: Module<
  IUserCenterOrganizationType,
  IRootState
> = {
  namespaced: true,
  state() {
    return {
      userCenterOrganizationsCount: 0,
      userCenterOrganizationsList: []
    }
  },
  mutations: {
    changeUserCenterOrganizationsList(
      state,
      userCenterOrganizationsList: any[]
    ) {
      state.userCenterOrganizationsList = userCenterOrganizationsList
    },
    changeUserCenterOrganizationsCount(
      state,
      userCenterOrganizationsCount: number
    ) {
      state.userCenterOrganizationsCount = userCenterOrganizationsCount
    }
  },
  getters: {
    pageListData(state) {
...
export default userCenterOrganizationModule
