 ...
 * @LastEditTime: 2022-07-19 11:22:48
...
export function useStoreName() {
  const storeTypeInfo = ref({
    actionName: 'userCenterOrganizationModule/getPageListAction',
    actionListName: 'userCenterOrganizationModule/pageListData',
    actionCountName: 'userCenterOrganizationModule/pageListCount',
    deleteAction: 'userCenterOrganizationModule/deletePageDataAction',
    sortAction: 'userCenterOrganizationModule/sortPageDataAction'
  })
  const operationName = ref({
    editName: 'userCenterOrganizationModule/editPageDataAction',
    createName: 'userCenterOrganizationModule/createPageDataAction'
  })
