...
export function useStoreName() {
  const storeTypeInfo = ref({
    actionName: 'baseJumpModule/getPageListAction',
    actionListName: 'baseJumpModule/pageListData',
    actionCountName: 'baseJumpModule/pageListCount',
    deleteAction: 'baseJumpModule/deletePageDataAction',
    sortAction: 'baseJumpModule/sortPageDataAction'
  })
  const operationName = ref({
    editName: 'baseJumpModule/editPageDataAction',
    createName: 'baseJumpModule/createPageDataAction'
  })
