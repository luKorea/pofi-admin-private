# 页面复杂度整理
  1. <u>（level 划分 1容易 2一般 3难）</u>
          1. 系统管理
             1. 系统管理/权限管理 1 (success)
             2. 系统管理/角色管理 2 (success)
             3. 系统管理/用户管理 2 (success)
             4. 系统管理/路由列表 2 (success)
        2.  意见反馈
             1. 意见反馈/问题列表 1
        3. 审核管理
             1. 审核管理/用户资料审核 2
        4. 商品中心
             1. 商品中心/充值套餐 1 tomorrow
             2. 商品中心/功能套餐 1 tomorrow
             3. 商品中心/套餐文案 3 (多语言)
             4. 商品中心/资源商品 3 (多语言)
        5. 资料库
             1. 资料库/资源数据统计 2
             2. 资料库/资源管理中心 3 (使用Hytable定制化)  (多语言)
             3. 资料库/专题管理 3 (国家侧边)  (多语言)
             4. 资料库/首页管理 3 (国家侧边)  (多语言)
             5. 资料库/系列管理 3  (多语言)
             6. 资料库/分类管理 3  (多语言)
             7. 资料库/关键词管理 3  (多语言)
        6.  基础设置
             1. 基础设置/附件管理 2
             2. 基础设置/跳转设置 2 (自定义modal 下拉框)
             3. 基础设置/默认头像 2 (success)
             4. 基础设置/多语言管理 1 (success)
             5. 基础设置/配置管理（超级管理员，普通管理员区分--- 是否可搜索, 新增编辑字段） 3  (国家侧边)
             6. 基础设置/地区管理 2 (success)
             7. 基础设置/版本管理 3  (国家侧边) (自定义modal下拉框)
             8. 基础设置/模块功能管理 1  (国家侧边) (success)
        7. 用户管理
             1. 用户管理/用户管理 2
        8. 财务中心
             1. 财务中心/用户钱包 3
             2. 财务中心/订单管理 2 (success)
             3. 财务中心/内测记录 1 (success)
        9. 帮助中心
             1. 帮助中心/使用指南 2 (多语言)
             2. 帮助中心/功能说明分类 2 (多语言)
             3. 帮助中心/功能说明 2 (多语言)
             4. 帮助中心/问题类型管理 2 (多语言)
             5. 帮助中心/问题管理 2 (多语言)
             6. 帮助中心/联系账号 2 (自定义modal 下拉框)
        10. 活动中心
             1. 活动中心/充值页活动 2
        11. 设备管理
              1. 设备管理/限制条件 1 (success)
              2. 设备管理/用户设备清单 2 (success)
        12. 广告中心
              1. 广告中心/栏目广告 3 (国家侧边) (多语言)
# 公用页面划分
  1. 侧边国家划分
  2. 富文本编辑器
  3. 表格
